...
export default function CloseButton({ onClick }: CloseButtonProps) {
	return (
		<div
			onClick={onClick}
			className="box-border content-stretch flex gap-[20px] items-center justify-center px-[20px] py-[12px] relative rounded-[16px] shrink-0 cursor-pointer hover:opacity-70 transition-opacity"
			data-name="Close"
			role="button"
			tabIndex={0}
			onKeyDown={(e) => {
