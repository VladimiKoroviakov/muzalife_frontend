...
export function BackButton({ onClick }: BackButtonProps) {
  return (
    <div onClick={onClick} className="cursor-pointer box-border border border-solid border-white content-stretch flex gap-[20px] items-center justify-center px-[20px] py-[12px] rounded-[16px] shrink-0 hover:opacity-70 transition-opacity" data-name="Close">
          <div className="relative shrink-0 size-[28px] pointer-events-none" data-name="back-button">
